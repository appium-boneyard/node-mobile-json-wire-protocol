...
class JavaScriptError extends MJSONWPError {
  ...
  constructor (err) {
    super(err || 'An error occurred while executing user supplied JavaScript.', JavaScriptError.code());
  }
}
...
class XPathLookupError extends MJSONWPError {
  ...
  constructor (err) {
    super(err || 'An error occurred while searching for an element by XPath.', XPathLookupError.code());
  }
}
...
class TimeoutError extends MJSONWPError {
  ...
  constructor (err) {
    super(err || 'An operation did not complete before its timeout expired.', TimeoutError.code());
  }
}
...
class UnableToSetCookieError extends MJSONWPError {
  ...
  constructor (err) {
    super(err || 'A request to set a cookie\'s value could not be satisfied.', UnableToSetCookieError.code());
  }
}
...
class UnexpectedAlertOpenError extends MJSONWPError {
  ...
  constructor (err) {
    super(err || 'A modal dialog was open, blocking this operation', UnexpectedAlertOpenError.code());
  }
}
...
class ScriptTimeoutError extends MJSONWPError {
  ...
  constructor (err) {
    super(err || 'A script did not complete before its timeout expired.', ScriptTimeoutError.code());
  }
}
...
class IMEEngineActivationFailedError extends MJSONWPError {
  ...
  constructor (err) {
    super(err || 'An IME engine could not be started.', IMEEngineActivationFailedError.code());
  }
}
...
class InvalidSelectorError extends MJSONWPError {
  ...
  constructor (err) {
    super(err || 'Argument was an invalid selector (e.g. XPath/CSS).', InvalidSelectorError.code());
  }
}
