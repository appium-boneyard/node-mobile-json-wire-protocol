...
class NoSuchDriverError extends MJSONWPError {
  ...
  constructor () {
    super('A session is either terminated or not started', NoSuchDriverError.code());
  }
}
...
class JavaScriptError extends MJSONWPError {
  ...
  constructor () {
    super('An error occurred while executing user supplied JavaScript.', JavaScriptError.code());
  }
}
...
class XPathLookupError extends MJSONWPError {
  ...
  constructor () {
    super('An error occurred while searching for an element by XPath.', XPathLookupError.code());
  }
}
...
class TimeoutError extends MJSONWPError {
  ...
  constructor () {
    super('An operation did not complete before its timeout expired.', TimeoutError.code());
  }
}
...
class UnableToSetCookieError extends MJSONWPError {
  ...
  constructor () {
    super('A request to set a cookie\'s value could not be satisfied.', UnableToSetCookieError.code());
  }
}
...
class UnexpectedAlertOpenError extends MJSONWPError {
  ...
  constructor () {
    super('A modal dialog was open, blocking this operation', UnexpectedAlertOpenError.code());
  }
}
...
class ScriptTimeoutError extends MJSONWPError {
  ...
  constructor () {
    super('A script did not complete before its timeout expired.', ScriptTimeoutError.code());
  }
}
...
class IMENotAvailableError extends MJSONWPError {
  ...
  constructor () {
    super('IME was not available.', IMENotAvailableError.code());
  }
}
...
class IMEEngineActivationFailedError extends MJSONWPError {
  ...
  constructor () {
    super('An IME engine could not be started.', IMEEngineActivationFailedError.code());
  }
}
...
class InvalidSelectorError extends MJSONWPError {
  ...
  constructor () {
    super('Argument was an invalid selector (e.g. XPath/CSS).', InvalidSelectorError.code());
  }
}
...
class MoveTargetOutOfBoundsError extends MJSONWPError {
  ...
  constructor () {
    super('Target provided for a move action is out of bounds.',
...
class NoSuchContextError extends MJSONWPError {
  ...
  constructor () {
    super('No such context found.', NoSuchContextError.code());
  }
}
...
class InvalidContextError extends MJSONWPError {
  ...
  constructor () {
    super('That command could not be executed in the current context.', InvalidContextError.code());
  }
}
...
class NotYetImplementedError extends MJSONWPError {
  ...
  constructor () {
    super('Method has not yet been implemented', NotYetImplementedError.code());
  }
}
...
class NotImplementedError extends MJSONWPError {
  ...
  constructor () {
    super('Method is not implemented', NotImplementedError.code());
  }
}
