...
class NoSuchDriverError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'A session is either terminated or not started', NoSuchDriverError.code());
  }
}
...
class NoSuchElementError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'An element could not be located on the page using the given ' +
...
class NoSuchFrameError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'A request to switch to a frame could not be satisfied because ' +
...
class UnknownCommandError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'The requested resource could not be found, or a request was ' +
...
class StaleElementReferenceError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'An element command failed because the referenced element is no ' +
...
class ElementNotVisibleError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'An element command could not be completed because the element is ' +
...
class UnknownError extends MJSONWPError {
  ...
  constructor (originalError) {
    ...
    let message = 'An unknown server-side error occurred while processing ' +
                  'the command.';
    if (originalError) {
      message += ` Original error: ${origMessage}`;
    }
...
class JavaScriptError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'An error occurred while executing user supplied JavaScript.', JavaScriptError.code());
  }
}
...
class XPathLookupError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'An error occurred while searching for an element by XPath.', XPathLookupError.code());
  }
}
...
class TimeoutError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'An operation did not complete before its timeout expired.', TimeoutError.code());
  }
}
...
class NoSuchWindowError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'A request to switch to a different window could not be satisfied ' +
...
class InvalidCookieDomainError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'An illegal attempt was made to set a cookie under a different ' +
...
class UnableToSetCookieError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'A request to set a cookie\'s value could not be satisfied.', UnableToSetCookieError.code());
  }
}
...
class UnexpectedAlertOpenError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'A modal dialog was open, blocking this operation', UnexpectedAlertOpenError.code());
  }
}
...
class NoAlertOpenError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'An attempt was made to operate on a modal dialog when one ' +
...
class ScriptTimeoutError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'A script did not complete before its timeout expired.', ScriptTimeoutError.code());
  }
}
...
class IMENotAvailableError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'IME was not available.', IMENotAvailableError.code());
  }
}
...
class IMEEngineActivationFailedError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'An IME engine could not be started.', IMEEngineActivationFailedError.code());
  }
}
...
class InvalidSelectorError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'Argument was an invalid selector (e.g. XPath/CSS).', InvalidSelectorError.code());
  }
}
...
class NoSuchContextError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'No such context found.', NoSuchContextError.code());
  }
}
...
class InvalidContextError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'That command could not be executed in the current context.', InvalidContextError.code());
  }
}
...
class NotYetImplementedError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'Method has not yet been implemented', NotYetImplementedError.code());
  }
}
...
class NotImplementedError extends MJSONWPError {
  ...
  constructor (msg) {
    super(msg || 'Method is not implemented', NotImplementedError.code());
  }
}
