...
function driverShouldDoJwpProxy (driver, req, command) {
  ...
  driver = getActualDriver(driver, req);
...
async function doJwpProxy (driver, req, res) {
  ...
  if (!_.isFunction(getActualDriver(driver, req).proxyReqRes)) {
...
function getActualDriver (driver, req) {
  return driver.driverForSession(req.params.sessionId) || driver;
}
