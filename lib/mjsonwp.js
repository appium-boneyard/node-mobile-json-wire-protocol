        ...
        app[method.toLowerCase()](path, async (req, res) => {
          ...
          try {
            ...
            try {
              ...
              // if the driver command fails, throw an UnknownError after
              // getting the appropriate information from the originating
              // error. Unless, that is, it throws a NotYetImplemented.
              if (e instanceof errors.NotYetImplementedError) {
                throw e;
              }
              throw new errors.UnknownError(e);
            }
            ...
            [httpStatus, httpResBody] = getResponseForJsonwpError(err);
          }
