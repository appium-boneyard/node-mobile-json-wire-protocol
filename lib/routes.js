const METHOD_MAP = {
  ...
  '/wd/hub/session/:sessionId/frame': {
    POST: {command: 'setFrame', payloadParams: {required: ['frameId']}}
  },
 ...
 '/wd/hub/session/:sessionId?/element/:elementId?': {
  ...
  '/wd/hub/session/:sessionId/moveto': {
    POST: {command: 'moveTo', payloadParams: {required: [['element'], ['xOffset', 'yOffset']]}}
  },
  '/wd/hub/session/:sessionId/click': {
    POST: {command: 'clickCurrent', payloadParams: {required: ['button']}}
  },
  ...
  '/wd/hub/session/:sessionId/touch/flick': {
    POST: {command: 'pickAFlickMethod', payloadParams: {required: ['element', 'xspeed', 'yspeed', 'xoffset', 'yoffset', 'speed']}}
  },
  '/wd/hub/session/:sessionId?/location': {
    GET: {}
  },
  '/wd/hub/session/:sessionId/location': {
    POST: {command: 'setLocation', payloadParams: {required: ['location']}}
  },
 ...
 '/wd/hub/session/:sessionId/appium/device/shake': {
  ...
  '/wd/hub/session/:sessionId/appium/device/keyevent': {
    POST: {command: 'keyevent', payloadParams: {required: ['keycode', 'metastate']}}
  },
  '/wd/hub/session/:sessionId/appium/device/rotate': {
    POST: {command: 'mobileRotation', payloadParams: {required: ['x', 'y', 'radius', 'rotation', 'touchCount', 'duration', 'element']}}
  },
  ...
  '/wd/hub/session/:sessionId/appium/app/strings': {
    POST: {command: 'getStrings', payloadParams: {required: ['language', 'stringFile']}}
  },
  ...
  '/wd/hub/session/:sessionId/appium/settings': {
    ...
    GET: {command: 'getSettings', payloadParams: {required: ['settings']}}
  }
};
