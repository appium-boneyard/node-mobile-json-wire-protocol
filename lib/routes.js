const METHOD_MAP = {
  ...
  // TODO: figure out how to make requiredCapabilities optional
  '/wd/hub/session': {
    POST: {command: 'createSession', payloadParams: ['desiredCapabilities', 'requiredCapabilities']}
  },
  '/wd/hub/sessions': {
  ...
  '/wd/hub/session/:sessionId/timeouts': {
    POST: {command: 'timeouts', payloadParams: ['type', 'ms']}
  },
  '/wd/hub/session/:sessionId/timeouts/async_script': {
    POST: {command: 'asyncScriptTimeout', payloadParams: ['ms']}
  },
  '/wd/hub/session/:sessionId/timeouts/implicit_wait': {
    POST: {command: 'implicitWait', payloadParams: ['ms']}
  },
  ...
  '/wd/hub/session/:sessionId/execute': {
    POST: {command: 'execute', payloadParams: ['script', 'args']}
  },
  '/wd/hub/session/:sessionId/execute_async': {
    POST: {command: 'executeAsync', payloadParams: ['script', 'args']}
  },
  ...
  '/wd/hub/session/:sessionId/ime/activate': {
    POST: {command: 'activateIMEEngine', payloadParams: ['engine']}
  },
  '/wd/hub/session/:sessionId/frame': {
    POST: {command: 'frame', payloadParams: ['frameId']}
  },
  '/session/:sessionId/frame/parent': {
    POST: {}
  },
  '/wd/hub/session/:sessionId/window': {
    POST: {command: 'setWindow', payloadParams: ['name']},
  ...
  '/wd/hub/session/:sessionId/cookie': {
    ...
    POST: {command: 'setCookie', payloadParams: ['cookie']},
  ...
  '/wd/hub/session/:sessionId/element': {
    POST: {command: 'findElement', payloadParams: ['using', 'value']}
  },
  '/wd/hub/session/:sessionId/elements': {
    POST: {command: 'findElements', payloadParams: ['using', 'value']}
  },
 ...
 '/wd/hub/session/:sessionId?/element/:elementId?': {
  ...
  '/wd/hub/session/:sessionId/element/:elementId/element': {
    POST: {command: 'findElementFromElement', payloadParams: ['using', 'value']}
  },
  '/wd/hub/session/:sessionId/element/:elementId/elements': {
    POST: {command: 'findElementsFromElement', payloadParams: ['using', 'value']}
  },
  ...
  '/wd/hub/session/:sessionId/element/:elementId/value': {
    POST: {command: 'setValue', payloadParams: ['value']}
  },
  '/wd/hub/session/:sessionId/keys': {
    POST: {command: 'keys', payloadParams: ['value']}
  },
  ...
  '/wd/hub/session/:sessionId/orientation': {
    ...
    POST: {command: 'setOrientation', payloadParams: ['orientation']}
  },
  '/wd/hub/session/:sessionId/alert_text': {
    GET: {command: 'getAlertText'},
    POST: {command: 'setAlertText', payloadParams: ['text']}
  },
  ...
  '/wd/hub/session/:sessionId/moveto': {
    POST: {command: 'moveTo', payloadParams: ['element', 'xOffset', 'yOffset'] }
  },
  '/wd/hub/session/:sessionId/click': {
    POST: {command: 'clickCurrent', payloadParams: ['button']}
  },
  ...
  '/wd/hub/session/:sessionId/touch/click': {
    POST: {command: 'click', payloadParams: ['element']}
  },
  '/wd/hub/session/:sessionId/touch/down': {
    POST: {command: 'touchDown', payloadParams: ['x', 'y']}
  },
  '/wd/hub/session/:sessionId/touch/up': {
    POST: {command: 'touchUp', payloadParams: ['x', 'y']}
  },
  '/wd/hub/session/:sessionId/touch/move': {
    POST: {command: 'touchMove', payloadParams: ['x', 'y']}
  },
  ...
  '/wd/hub/session/:sessionId/touch/longclick': {
    POST: {command: 'touchLongClick', payloadParams: ['elements']}
  },
  '/wd/hub/session/:sessionId/touch/flick': {
    POST: {command: 'pickAFlickMethod', payloadParams: ['element', 'xspeed', 'yspeed', 'xoffset', 'yoffset', 'speed']}
  },
  '/wd/hub/session/:sessionId?/location': {
    GET: {}
  },
  '/wd/hub/session/:sessionId/location': {
    POST: {command: 'setLocation', payloadParams: ['location']}
  },
  ...
  '/wd/hub/session/:sessionId/log': {
    POST: {command: 'getLog', payloadParams: ['type']}
  },
  ...
  '/wd/hub/session/:sessionId/context': {
    ...
    POST: {command: 'setContext', payloadParams: ['name']}
  },
  ...
  '/wd/hub/session/:sessionId/network_connection': {
    ...
    POST: {command: 'setNetworkConnection', payloadParams: ['type']}
  },
  '/wd/hub/session/:sessionId/touch/perform': {
    POST: {command: 'performTouch', payloadParams: ['gestures']}
  },
  '/wd/hub/session/:sessionId/touch/multi/perform': {
    POST: {command: 'performMultiAction', payloadParams: ['elementId', 'actions']}
  },
  '/wd/hub/session/:sessionId/receive_async_response': {
    POST: {command: 'receiveAsyncResponse', payloadParams: ['response']}
  },
 '/wd/hub/session/:sessionId/appium/device/shake': {
    POST: {command: 'mobileShake'}
  },
  '/wd/hub/session/:sessionId/appium/device/lock': {
    POST: {command: 'lock', payloadParams: ['seconds']}
  },
  ...
  '/wd/hub/session/:sessionId/appium/device/press_keycode': {
    POST: {command: 'pressKeyCode', payloadParams: ['keycode', 'metastate']}
  },
  '/wd/hub/session/:sessionId/appium/device/long_press_keycode': {
    POST: {command: 'longPressKeyCode', payloadParams: ['keycode', 'metastate']}
  },
  '/wd/hub/session/:sessionId/appium/device/keyevent': {
    POST: {command: 'keyevent', payloadParams: ['keycode', 'metastate']}
  },
  '/wd/hub/session/:sessionId/appium/device/rotate': {
    POST: {command: 'mobileRotation', payloadParams: ['x', 'y', 'radius', 'rotation', 'touchCount', 'duration', 'element']}
  },
  ...
  '/wd/hub/session/:sessionId/appium/device/install_app': {
    POST: {command: 'installApp', payloadParams: ['appPath']}
  },
  '/wd/hub/session/:sessionId/appium/device/remove_app': {
    POST: {command: 'removeApp', payloadParams: ['appId', 'bundleId']}
  },
  '/wd/hub/session/:sessionId/appium/device/app_installed': {
    POST: {command: 'isAppInstalled', payloadParams: ['bundleId']}
  },
  '/wd/hub/session/:sessionId/appium/device/hide_keyboard': {
    POST: {command: 'hideKeyboard', payloadParams: ['key', 'keyName', 'strategy']}
  },
  '/wd/hub/session/:sessionId/appium/device/push_file': {
    POST: {command: 'pushFile', payloadParams: ['path', 'data']}
  },
  '/wd/hub/session/:sessionId/appium/device/pull_file': {
    POST: {command: 'pullFile', payloadParams: ['path']}
  },
  '/wd/hub/session/:sessionId/appium/device/pull_folder': {
    POST: {command: 'pullFolder', payloadParams: ['path']}
  },
  ...
  '/wd/hub/session/:sessionId/appium/app/background': {
    POST: {command: 'background', payloadParams: ['seconds']}
  },
  '/wd/hub/session/:sessionId/appium/app/end_test_coverage': {
    POST: {command: 'endCoverage', payloadParams: ['intent', 'path']}
  },
  '/wd/hub/session/:sessionId/appium/app/strings': {
    POST: {command: 'getStrings', payloadParams: ['language', 'stringFile']}
  },
  '/wd/hub/session/:sessionId/appium/element/:elementId/value': {
    POST: {command: 'setValueImmediate', payloadParams: ['value']}
  },
  '/wd/hub/session/:sessionId/appium/element/:elementId/replace_value': {
    POST: {command: 'replaceValue', payloadParams: ['value']}
  },
  '/wd/hub/session/:sessionId/appium/settings': {
    POST: {command: 'updateSettings'},
    GET: {command: 'getSettings', payloadParams: ['settings']}
  }
};
